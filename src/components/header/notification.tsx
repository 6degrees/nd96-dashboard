...
export default function Notification() {
    ...
    /*
     ...
     |
     */
    const { list, loading } = useCollections()
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                {item.url && (
                                                    <a href={`/dashboard${item.url}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-[11px] font-medium text-violet-600 dark:!text-white hover:text-violet-700 dark:hover:text-violet-300 bg-violet-500/10 hover:bg-violet-500/20 px-2.5 py-1 rounded-lg transition-colors">
                                                        {t('common.view')}
